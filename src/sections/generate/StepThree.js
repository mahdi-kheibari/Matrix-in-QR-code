    ...
    <Grid container spacing={1} sx={{ mt: 3 }}>
      <Grid item xs={9}>
        <Stack direction={"column"} spacing={1.5} sx={{ "& .MuiTypography-root": { fontWeight: "500 !important" } }}>
          ...
          <Typography className='text-wrapper' variant={mdAndDown ? "h5" : "h4"} sx={{ display: "flex", alignItems: "center", }}>
          ...
          <Typography className='text-wrapper' variant={mdAndDown ? "h5" : "h4"} sx={{ display: "flex", alignItems: "center", overflow: "hidden" }}>
            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="38" height="38" viewBox="0 0 48 48">
          ...
          {binaryData.map((item, index) => (
            <Grid item xs={12} key={index}>
              <Box className="binary-data" sx={{ width: "100%", height: "100%", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 2 }}>
                ...
                <Box sx={{ position: "relative", lineHeight: { xs: "5px", md: "initial" } }}>
